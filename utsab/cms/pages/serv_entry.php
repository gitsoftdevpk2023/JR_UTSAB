...
/*		 $mname1 =$_FILES["model_pro_pic"]["name"];
		...
		//	 $sql="UPDATE `service_master` SET `serv_logo` = '$mname1' where id='$last_id'";
		...
		$sql="INSERT INTO  service_master(`serv_name`,`serv_details`,`serv_pic`,`serv_rate`)VALUES ('$cat_name','$cat_description','','$cat_rate')";
...
<thead>
  ...
  <tr>
    ...
    <td colspan="2">Room Type Entry</td>
  </tr>
</thead>
...
<tbody>
  ...
  <tr>
    <td>Rate</td>
    <td><input class="form-control" type="number" name="cat_rate" />  </tr>
  <tr>
