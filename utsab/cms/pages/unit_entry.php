...
if(isset($_POST['Submit']))
  {
    ...
    $sql="INSERT INTO unit_master(`unit_name`,`unit_sign`,`unit_status`)VALUES ('$course_name','$course_duraction','ACTIVE')";
      mysqli_query($dbhandle,$sql);
      //echo $sql;
      echo "<script>window.location.href = 'home.php?op=unit_view&msg=success'</script>";
    
  }else{
?>
<div class="card">
                <div class="card-header">
                  <strong> Unit Entry</strong>                </div>
<div class="card-body">
                  <form method="post" enctype="multipart/form-data" name="add_pro_dtls_frm" onSubmit="return validateForm()" class="form-horizontal">
                    ...
                    <div class="form-group row">
                    <label class="col-md-3 col-form-label" for="text-input"> Unit Sign <font color="red"> *</font></label>
                      <div class="col-md-9">
                        <input class="form-control" type="text" id="course_duraction" name="course_duraction" placeholder="Enter Sign">
                      </div>
                    </div>
