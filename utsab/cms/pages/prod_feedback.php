<?php
	$sql="select feedack_master_prod.*,product_name from feedack_master_prod,product_details where fdbk_status='ACTIVE' and fdbk_prod=pro_id order by id desc";
...
<thead>
  <tr>
		<td class="special" colspan="7" align="left">PRODUCT ENQUIRY LIST</td>
  </tr>
  <tr id="welcome" class="post">
	...
	<th align="left" valign="top" width="10%">Product</th>
	</tr>
</thead>
<tbody>
<?php
...
?>
	  <tr>
		...
		<td align="left" valign="top"><div align="justify"><?php echo $row['fdbk_matter'];?></div></td>
		<td align="left" valign="top"><div align="center"><?php echo $row['product_name'];?></div></td>
