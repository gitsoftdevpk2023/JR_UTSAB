<?php
	if(isset($_POST['Submit']))
	{
		...
		//	 $sql="UPDATE `news_master` SET `news_pic` = '$mname1' where id='$last_id'";
	 	//	mysqli_query($dbhandle,$sql);
		 }
		
		$sql="INSERT INTO  news_master(`news_name`,`news_details`,`status`,`news_pic`,`news_date`)VALUES ('$cat_name','$cat_description','ACTIVE','$mname1','$dt')";
			mysqli_query($dbhandle,$sql);
...
<tbody>
  ...
  <tr>
    <td>News Date </td>
    <td><input class="form-control" type="date" name="dt" />  
  </tr>
  <tr>
