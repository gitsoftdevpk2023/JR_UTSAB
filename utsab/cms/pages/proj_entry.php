<?php
	if(isset($_POST['Submit']))
	{
		...
		//	 $sql="UPDATE `proj_master` SET `proj_logo` = '$mname1' where id='$last_id'";
	 	//	mysqli_query($dbhandle,$sql);
		 }
		
		$sql="INSERT INTO  proj_master(`proj_name`,`proj_details`,`proj_status`,`proj_pic`,`proj_cust`,`proj_location`)VALUES ('$cat_name','$cat_description','ACTIVE','$mname1','$cat_cust','$cat_location')";
			mysqli_query($dbhandle,$sql);
...
<tbody>
  ...
  <tr>
   ...
   <tr>
     <td>Customer</td>
     <td><textarea name="cat_cust" rows="5" cols="20" class="form-control"></textarea></td>
   </tr>
   <tr>
     <td>Location</td>
     <td><textarea name="cat_location" rows="5" cols="20" class="form-control"></textarea></td>
   </tr>
   <tr>
