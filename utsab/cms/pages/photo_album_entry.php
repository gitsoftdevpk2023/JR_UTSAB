<?php
	if(isset($_POST['Submit']))
	{
		...
		$sql="INSERT INTO photo_cat(`photo_cat_name`,`photo_cat_status`,`photo_cat_details`,`photo_cat_pic`)VALUES ('$cat_name','ACTIVE','$cat_description','$mname1')";
...
<thead>
  <tr>
    <td colspan="2">Photo Album  Entry</td>
  </tr>
</thead>
<tbody>
  <tr>
  ...
  <tr>
    ...
    <td width="70%"><div id="t_cat_description">
	  <input name="cat_description" type="number" class="form-control" value="" size="4" />
    </div>
